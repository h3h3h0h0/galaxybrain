...
then
  D:/Programs/MSVS/Common7/IDE/CommonExtensions/Microsoft/CMake/Ninja/ninja.exe $targets_to_make ${EIGEN_MAKE_ARGS}
else
  D:/Programs/MSVS/Common7/IDE/CommonExtensions/Microsoft/CMake/Ninja/ninja.exe $targets_to_make 
fi
exit $?
